          ...
          <div className="card-body">
            ...
            <div className="form-check">
              <input
                ...
                id="checkboxBaru"
              />
              <label className="label-filter-new" htmlFor="checkboxBaru">
                Paling Baru
              </label>
            </div>
            <div className="form-check">
              <input
                ...
                id="checkboxPopular"
              />
              <label className="label-filter-popular" htmlFor="checkboxPopular">
                Paling Populer
              </label>
            </div>
            <div className="form-check">
          ...
          <div className="card-body">
            ...
            <div className="form-check">
              <input
                ...
                id="checkboxUIDesign"
              />
              <label className="label-filter" htmlFor="checkboxUIDesign">
                UI/UX Design
              </label>
            </div>
            <div className="form-check">
              ...
              />
              <label className="label-filter" htmlFor="checkboxWebDevelopment">
                Web Development
              </label>
            </div>
            <div className="form-check">
          ...
          <div className="card-body">
            ...
            <div className="form-check">
              <input
                ...
                id="checkboxAllLevel"
              />
              <label className="label-filter" htmlFor="checkboxAllLevel">
                Semua Level
              </label>
            </div>
            <div className="form-check">
              ...
              />
              <label className="label-filter" htmlFor="checkboxBeginnerLevel">
                Beginner Level
              </label>
            </div>
            <div className="form-check">
            ...
            <div className="form-check">
              ...
              />
              <label className="label-filter" htmlFor="checkboxAdvancedLevel">
                Advanced Level
              </label>
            </div>
          </div>
