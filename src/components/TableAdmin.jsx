...
//                       >
//                         <span style={{ color: `var(--primary-purple)` }}><MdEdit /></span>
//                       </button>
//                       <button
//                         onClick={() => handleDelete(index)}
//                         className="btn text-light rounded-pill"
//                       >
//                         <span style={{ color: `var(--allert-red)` }}><IoTrash /></span>
//                       </button>
//                     </div>
//                   )}
//                 </div>
...
//                     </th>
//                   ))}
//                   {isKelolaKelasRoute && <th className="d-flex justify-content-center" style={{backgroundColor:`var(--primary-young-blue)`}}>Action</th>}
//                 </tr>
//               </thead>
//               <tbody>
//                 {data.map((aData, index) => (
