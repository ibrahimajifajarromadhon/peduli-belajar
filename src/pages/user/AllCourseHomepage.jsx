      ...
      <div className='row'>
        ...
        <div className='col-md-8' style={{ marginBottom: '2em' }}>
          <div className='btn-menu d-flex mt-4'>
            <Link to={"/allCourseClass"} className='btn btn-light me-4' style={{width:'20%', backgroundColor: "#6148FF", color: "white", padding:"10px", borderRadius:"15px", fontWeight:"600"}}>All</Link>
