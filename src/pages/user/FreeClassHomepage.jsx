      ...
      <div className='row'>
        ...
        <div className='col-md-8'>
          <div className='btn-menu d-flex mt-4'>
            ...
            <Link to={"/premiumClass"} className='btn btn-light me-4' style={{width:'40%'}}>Kelas Premium</Link>
            <Link to={"/freeClass"} className='btn btn-light me-4' style={{width:'30%', backgroundColor: "#6148FF", color: "white"}}>Kelas Gratis</Link>
          </div>
          <div className='mt-3'>
            <ListCourse />    
          </div>
